...
|------|----------|------|------|----------|------|
| ChatGPT | GPT‑5.5 | OpenAI | 基础（多模态文本推理） | 否 | chatgpt.com |
| Claude | Claude 4.7 Opus, Sonnet | Anthropic | 基础（多模态文本推理） | 否 | claude.ai |
| Gemini | Gemini 3.1 Pro, Flash | Google DeepMind | 基础（多模态文本推理） | 否 | gemini.google.com |
...
| Midjourney | V7 | Midjourney | 图像生成 | 否 | midjourney.com |
| Stable Diffusion | 4.0 | Stability AI | 图像生成 | 是 | stability.ai |
| Stable Audio | 2.0 | Stability AI | 音乐/音频生成 | 是 | stability.ai |
| Suno | V4.5 | Suno AI | 音乐生成 | 否 | suno.com |
| Udio | v2 | Udio | 音乐生成 | 否 | udio.com |
| Runway Gen | Gen‑4 | Runway | 视频生成 | 否 | runwayml.com |
| Kling (可灵) | 2.0 | 快手 | 视频生成 | 否 | kling.kuaishou.com |
| Pika | 2.0 | Pika Labs | 视频生成 | 否 | pika.art |
